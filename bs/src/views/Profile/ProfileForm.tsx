...
export default class ProfileForm extends BaseForm<Props> {
  constructor(props: Props) {
    ...
    this.addField('GroupId',    'Ryhmä',            'number', { required: true, readonly: true, lookupUrl: 'usergroup' });
    ...
    if (this.user && this.user.isUserOrHigher) {
      this.addField('MaxOpenQuestions', 'Avoimia vikatapauksia enintään', 'number', { readonly: true });
